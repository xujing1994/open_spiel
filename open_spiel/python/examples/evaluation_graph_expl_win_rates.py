...
def main(argv):
    ...
    expl_0.append(read_exploitability('/home/jxu8/Code_update/open_spiel/evaluation_data/eval_ttt_nfsp_0.1_8_6/exploitabilities.txt'))
    ...
    expl_0.append(read_exploitability((kuhn_poker_nfsp_0 + 'exploitability/eta_0/exploitability_avg.txt')))
    expl_1.append(read_exploitability((kuhn_poker_nfsp_1 + 'exploitability/eta_0/exploitability_avg.txt')))
    ...
    # plot win rates of trained agents against each other in ttt_nfsp_0.1_7_26
    plt.figure(figsize=(15, 20))
    # fig.suptitle("win rates against each other")
    ax2 = plt.subplot(511)
    ax2.set_title("win rates against each other(eta 0 for both in evaluation)")
    ...
    # plot random agent0 against trained agent1 in ttt_nfsp_1_7_29
    plt.figure(figsize=(15, 12))
    ax2 = plt.subplot(311)
    ax2.set_title('random agent0 against trained agent1(eta 0 in evaluation)')
    plt.ylim(0, 1)
    ...
    # plot win rates of trained agents against each other in ttt_nfsp_1_7_29
    plt.figure(figsize=(15, 20))
    # fig.suptitle("win rates against each other")
    ax2 = plt.subplot(511)
    ax2.set_title("win rates against each other(eta 0 for both in evaluation)")
